...
namespace TeklaModelPlugin
{
	...
	[Plugin("TeklaModelPlugin")]
	[PluginUserInterface("TeklaModelPlugin.MainForm")]
	public class TeklaModelPlugin : PluginBase
	{
		#region Fields
        ...
        */
		...
		#region Constructor
		public TeklaModelPlugin(PluginData data)
		{
			Model = new Model();
			Data = data;
		}
